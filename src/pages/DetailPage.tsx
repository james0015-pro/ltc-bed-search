        ...
        <div className="space-y-3 text-xs text-text-muted leading-relaxed">
          ...
          <div className="flex items-start gap-2">
            ...
            <div>
              ...
              <p>TVBS 2026/5/21 專題報導：台大醫院北護分院教授提出長照 3.0 核心新思維 — 「功能恢復模式」（Functional Recovery Model），主張長照不應只是「幫失能者洗澡、餵飯」，而應以恢復自立生活能力為目標。四大關鍵觀點：①長照 3.0 應建立「功能恢復評估指標」，取代現行僅看失能等級的補助計算方式，讓積極復健的個案獲得更多資源 ②國際趨勢（日本介護預防、北歐復能照護）皆顯示：投入 $1 在功能恢復可節省 $3 後續照護成本 ③台灣現行長照 2.0 體系下，僅 12% 的居家服務個案接受復能訓練，且復能服務時數僅佔總服務時數 3% — 嚴重失衡 ④建議住宿式機構納入「復能型長照床」，與醫院物理治療/職能治療師合作，讓機構不只是「等時間的地方」而是功能恢復的基地。此模式若獲政策採納，將顛覆傳統長照機構的營運邏輯：從「收容愈久、收費愈多」轉向「恢復愈快、週轉愈高」的價值導向模式。</p>
            </div>
          </div>
          <div className="flex items-start gap-2">
            <span className="text-info mt-0.5 shrink-0">ℹ</span>
